...
function buscarRevista_X_Titulo(tituloSitioWeb, tituloRevista){
    ...
    let archivoJSON = require(path.join(__dirname + `/../SGE_Arg/Revistas/${req.params.tituloSitioWeb}.json`)); // Busco el archivo .json
...
router.get('/:dataBase', function(req, res){
    ...
    let archivoJSON = require(path.join(__dirname + `/../SGE_Arg/Revistas/${req.params.dataBase}.json`));
    res.send(archivoJSON);
})


router.get('/:dataBase/titulo/:tituloRevista', function(req, res){
...
router.get('/:dataBase/ISSN/:issn', function(req, res){
